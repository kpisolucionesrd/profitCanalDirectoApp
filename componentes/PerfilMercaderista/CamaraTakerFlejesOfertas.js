...
export default class CamaraTakerFlejeOfertas extends Component{
  constructor(props){
    super(props);
    this.state={
  ...
  title: 'Tomar Fotos Fleje Ofertas',
  };
  ...
  render(){
    return(
      <ScrollView>
        ...
        <Text style={{marginTop:25,color:'red',fontWeight:'bold',fontSize:20}}>Cantidad de fotos: {this.state.fotos.length}</Text>
